...
class Campañas {
	...
	ArrayList<String> feriados = new ArrayList<String>(
		Arrays.asList("01/01/2015", "16/02/2015", "17/02/2015", "23/03/2015", "24/03/2015", "02/04/2015", "03/04/2015",
			"10/05/2015", "25/05/2015", "20/06/2015", "09/07/2015", "17/08/2015", "12/10/2015", "23/11/2015",
			"07/12/2015", "08/12/2015", "25/12/2015"))
	...
	new(String nombre, String formato, Date fecha_inicio, Date llegada_arte, Date pedido_prueba_color,
		Date ok_prueba_color, Date llegada_ajustes, Date aprobacion_oc, Date envio_oc, Date primer_entrega,
		Date segunda_entrega, Date inicio_instalacion, Date fin_instalacion, Date envio_cierre) {
		...
		if (llegada_ajustes != null) {
			this.llegada_ajustes = llegada_ajustes
		}
		if (segunda_entrega != null) {
			this.segunda_entrega = segunda_entrega
		}
	}
	...
	def retrasoPedidoPrueba() {
		...
		if (this.pedido_prueba_color != null && llegada_arte != null) {
			return ((this.pedido_prueba_color.getTime() - this.llegada_arte.getTime()) / (1000 * 60 * 60 * 24)).
				toString();
		} else {
			return ""
		}
	...
	def darEstadoArray() {
		var ArrayList<String> estado = new ArrayList<String>(
			Arrays.asList(nombre_campaña, formatoYcantidad, fecha_inicio.fechaToString, fechaArteOptima.fechaToString,
				llegada_arte.fechaToString, fechaPcOptima.fechaToString, pedido_prueba_color.fechaToString,
				ok_prueba_color.fechaToString, llegada_ajustes.fechaToString, fechaOptimaOC.fechaToString,
				aprobacion_oc.fechaToString, envio_oc.fechaToString, fechaOptimaEntrega.fechaToString,
				primer_entrega.fechaToString, segunda_entrega.fechaToString, fechaOptimaInicio.fechaToString,
				inicio_instalacion.fechaToString, fechaOptimaFin.fechaToString, fin_instalacion.fechaToString,
				envio_cierre.fechaToString, retrasoLlegadaArte, retrasoPedidoPrueba, retraso_okColor,
				retrasoAprobacionOC, retrasoOrdenCompra, retrasoPrimerEntrega, retrasoEntregaFinal,
				retrasoInicioColocacion, retrasoFinColocacion, retrasoEnvioCierre, arte.fechaToString,
				okReal.fechaToString, okIdeal.fechaToString))
